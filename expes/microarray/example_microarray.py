...
from sparse_ho.models import SimplexNuSVR
import pandas as pd
...
from ssvr.SMO_constrained import SMO_SSVR
import cvxpy as cp
...
np.save("results/estimated_cibersort.npy", estimated_cibersort)
np.save("results/estimated_ssvr.npy", estimated_ssvr)
np.save("results/estimated_SOLS.npy", estimated_SOLS)
np.save("results/ground_truth_simu.npy", ground_truth)