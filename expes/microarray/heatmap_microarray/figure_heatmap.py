...
for i, method in enumerate(methods):
    ...
    RMSE[RMSE<0] = 0.0
    cax = axarr[idx_row, i%3].imshow(RMSE.T, cmap='jet_r', interpolation='gaussian', aspect='auto', origin="lower", vmax=v_max, extent=[0, 1, 0, 1])
    

    axarr[idx_row, i%3].set_xlabel('Tumor content (\%)')
...
if save_fig:
    fig_dir = "/Users/quentin.klopfenstein/Documents/deconvolution_SSVR/Manuscript/figures/"
    fig.savefig(
...
for i, method in enumerate(methods):
    ...
    MAE[MAE<0] = 0.0
    cax = axarr[idx_row, i%3].imshow(MAE.T, cmap='jet_r', interpolation='gaussian', aspect='auto', origin="lower", vmax=v_max, extent=[0, 1, 0, 1])
...
for i, method in enumerate(methods):
    ...
    Corr[Corr<0] = 0.0
    cax = axarr[idx_row, i%3].imshow(Corr.T, cmap='jet', interpolation='gaussian', aspect='auto', origin="lower", vmax=v_max, vmin=0.0, extent=[0, 1, 0, 1])
