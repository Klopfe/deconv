...
#
# However, when we do this, we also import `deconv/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'deconv_cli = deconv.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'deconv_gui = deconv.gui:entry_point'
        # ]
    }
)
